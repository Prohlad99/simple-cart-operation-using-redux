      ...
      <div className=' mx-auto mt-4 shadow-lg rounded-md px-6 py-4 bg-indigo-300 w-[440px] grid justify-center'>
        ...
        <form action="">
            ...
            <div >
                ...
                <input className='w-[300px] rounded-md py-2 mt-1 outline-none px-2' type="password" id='confirm_password'/>
            </div>
        ...
        <div>
        <p className='text-center'>Already have an account? <Link to="/login"><button><span className='text-green-700'>Login</span></button></Link> </p>
